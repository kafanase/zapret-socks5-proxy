...
echo Launching Zapret with SOCKS5 proxy for the entire WiFi network...
echo.
...
:: Launching the SOCKS5 server in Python
echo Running the SOCKS5 server on port %SOCKS_PORT% for all WiFi devices...
start /min python "%BIN%socks5_server.exe" --host %WIFI_IP% --port %SOCKS_PORT%

echo.
echo ================================================
echo SOCKS5 proxy running: %WIFI_IP%:%SOCKS_PORT%
echo.
echo Settings for connecting from other devices:
echo The IP address of this computer: 
